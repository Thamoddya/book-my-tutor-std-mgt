...
<head>
    <meta charset="utf-8" />
    <title>
        Dashboard | Powerx - Bootstrap 5 Admin & Dashboard Template
    </title>
                    ...
                    <div class="app-search dropdown d-none d-lg-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                            ...
                            <div class="dropdown-header noti-title">
                                ...
                                >
                                    <i
                                        class="ri-file-chart-line fs-16 me-1"
                                    ></i>
                                ...
                                >
                                    <i
                                        class="ri-user-settings-line fs-16 me-1"
                                    ></i>
                                ...
                                <div class="dropdown-header noti-title">
                                    <h6
                                        class="text-overflow mt-2 mb-1 text-uppercase"
                                    >
                                        Users
                                    </h6>
                                </div>
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-3">
                        ...
                        <li class="dropdown notification-list">
                            ...
                            >
                                ...
                                <div style="max-height: 300px" data-simplebar>
                                    <h5
                                        class="text-muted fs-12 fw-bold p-2 text-uppercase mb-0"
                                    >
                                        Today
                                    </h5>
                                    <!-- item-->
                                    ...
                                    >
                                        <div class="card-body">
                                            ...
                                            >
                                                ...
                                                >
                                                    <h5
                                                        class="noti-item-title fw-semibold fs-14"
                                                    >
                                                        Datacorp
                                                        <small
                                                            class="fw-normal text-muted float-end ms-1"
                                                            >1 min ago</small
                                                        >
                                                    </h5>
                                                    <small
                                    ...
                                    <h5
                                        class="text-muted fs-12 fw-bold p-2 mb-0 text-uppercase"
                                    >
                                        Yesterday
                                    </h5>
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col">
                                            ...
                                            >
                                                <img
                                                    src="assets/images/brands/behance.png"
                                                    alt="Behance"
                                                />
                                                <span>Behance</span>
                                            </a>
                        ...
                        <li class="dropdown">
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="ri-account-circle-line fs-18 align-middle me-1"
                                    ></i>
                                ...
                                >
                                    <i
                                        class="ri-settings-4-line fs-18 align-middle me-1"
                                    ></i>
                                    <span>Settings</span>
                                </a>
                                ...
                                >
                                    <i
                                        class="ri-lock-password-line fs-18 align-middle me-1"
                                    ></i>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="bg-flower">
                                    <img
                                        src="assets/images/flowers/img-3.png"
                                    />
                                </div>
                                    ...
                                    <div class="page-title-right">
                                        <form class="d-flex">
                                            <div class="input-group">
                                                ...
                                                >
                                                    <i
                                                        class="ri-calendar-todo-fill fs-13"
                                                    ></i>
                                                </span>
                                            </div>
                                            <a
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <p class="mb-0 text-muted">
                                                    <span
                                                        class="text-white text-opacity-75 me-2"
                                                        ><i
                                                            class="ri-arrow-up-line"
                                                        ></i>
                                                        11.7%</span
        ...
        >
            ...
            <div class="offcanvas-footer border-top p-3 text-center">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="#" role="button" class="btn btn-primary w-100"
                            >Buy Now</a
                        >
                    </div>
                </div>
